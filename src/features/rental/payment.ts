import type { RentalGatewayOutcome } from "../../store/types";
...
export function resolveCardOutcome(cardNumber: string): RentalGatewayOutcome | null {
  const digits = normalizeDigits(cardNumber);
...
export function resolveMobileMoneyOutcome(phoneNumber: string): RentalGatewayOutcome | null {
