			...
			<ResponsiveShell>
				<Routes>
					...
					<Route path="rides">
						<Route
							index
							element={<Navigate to="/rides/enter" replace />}
						/>
						<Route path="enter" element={<RidesDashboard />} />
						<Route
							path="enter/details"
							element={<RideEnterDetails />}
						/>
						<Route
							path="enter/preferences"
							element={<Preferences />}
						/>
						...
						<Route
							path="upcoming-inline"
							element={<UpcomingInline />}
						/>
						<Route
							path="upcoming"
					...
					<Route path="deliveries">
						...
						<Route
							path="delivering-v2"
							element={<DeliveringV2 />}
						/>
						<Route path="received" element={<DeliveryReceived />} />
						<Route
							path="received-v2"
							element={<DeliveryReceivedV2 />}
						/>
						<Route
							path="received-v3"
							element={<DeliveryReceivedV3 />}
						/>
					...
					<Route path="ambulance">
						...
						<Route
							path="location"
							element={<AmbulanceLocation />}
						/>
						<Route
							path="destination"
							element={<AmbulanceDestination />}
						/>
						<Route
							path="confirmation"
