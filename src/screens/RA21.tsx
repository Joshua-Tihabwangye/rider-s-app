...
function PaymentMethodSelectionScreen(): React.JSX.Element {
  ...
  const handleConfirm = () => {
    if (fromSelectRide) {
      ...
      // Normal flow - go through payment simulation gateway first
      navigate("/payment/process", {
        state: {
          paymentMethod: selected,
          amount: fare,
          description: `EV Ride – ${rideData.pickup || "Pickup"} → ${rideData.destination || "Destination"}`,
          returnPath: "/rides/searching",
