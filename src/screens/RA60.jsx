...
function PackageTrackingEnRouteScreen() {
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
          ...
          <Box>
            ...
            >
              Package tracking – En route
            </Typography>
            <Typography
              variant="caption"
              sx={{ fontSize: 11, color: (t) => t.palette.text.secondary }}
            >
              Live courier location and ETA
            </Typography>
          </Box>
        </Box>
      </Box>
...
export default function RiderScreen60PackageTrackingEnRouteCanvas_v2() {
      return (
